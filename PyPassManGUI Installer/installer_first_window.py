...
class Ui_InstallerFirstWindow(object):
    ...
    def retranslateUi(self, InstallerFirstWindow):
        ...
        InstallerFirstWindow.setWindowTitle(_translate("InstallerFirstWindow", "PyPassMan Installer"))
        self.PassmanagerInstallerLabel.setText(_translate("InstallerFirstWindow", "PyPassMan Installer"))
        self.brDirC.setText(_translate("InstallerFirstWindow", "Install to C:\\PyPassMan"))
        self.brDirCProgramFiles.setText(_translate("InstallerFirstWindow", "Install to C:\\Program Files\\PyPassMan"))
        ...
        self.brUnins_dirC.setText(_translate("InstallerFirstWindow", "Uninstall from C:\\PyPassMan"))
        self.brUnins_dirCProgramFiles.setText(_translate("InstallerFirstWindow", "Uninstall from C:\\Program Files\\PyPassMan"))
