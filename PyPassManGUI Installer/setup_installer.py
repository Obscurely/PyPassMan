...
version_metadata = 'https://pastebin.com/f077vm8L'
file_name = 'PyPassMan.GUI.Stable.Release.zip'


def get_app():
    current_dir = os.getcwd()

    content = requests.get(version_metadata).text
    ...
    path = temp_folder + '\\PyPassMan\\' + file_name
...
def set_metadata(version):
    global version_metadata
    global file_name
    if version == 'Stable':
        version_metadata = 'https://pastebin.com/f077vm8L'
        file_name = 'PyPassMan.GUI.Stable.Release.zip'
    elif version == 'Beta':
        version_metadata = 'https://pastebin.com/BNQfeSrM'
        file_name = 'PyPassMan.GUI.Beta.Release.zip'
    elif version == 'Alpha':
        version_metadata = 'https://pastebin.com/BZm86uV1'
        file_name = 'PyPassMan.GUI.Alpha.Release.zip'
...
def setup():
    ...
    installer_first_form.cbVersion.addItem('Stable')
    installer_first_form.cbVersion.addItem('Beta')
    installer_first_form.cbVersion.addItem('Alpha')

    def change_version():
        version = installer_first_form.cbVersion.currentText()
    ...
    installer_first_form.bRefreshMetadata.clicked.connect(change_version)
